<?php 
    ...
    $sql = "SELECT * FROM post WHERE tag='programming'";
...
<nav class="navbar navbar-expand-lg navbar-light" style="padding:2%;padding-left:7%">
  ...
  <div class="collapse navbar-collapse" id="navbarNav" style="padding-left:30%">
    <ul class="navbar-nav">
      ...
      <button class="btn btn-outline-primary my-2 my-sm-0" type="button" style="margin-left:12%" onclick="location.href='login.php'">Login</button>
    </ul>
  </div>
</nav>

<div class="container-fluid text-center jumbotron" style="background-image:url('programming.jpg');height:200px;color:white;">
    <h1>Programming</h1>
</div>
